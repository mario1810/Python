...
assert name_declarations == [
    ...
    "Fred Ward is 77 years old",    "Kevin Bacon is 61 years old",    "Victor Wong is 74 years old",
...
under_seventy = sorted(filter(lambda d: d['age']<70,sorted_by_name), key=lambda d: d['age'])
